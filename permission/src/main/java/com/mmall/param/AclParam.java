/*
 * AclParam.java 1.0.0 2018/2/12  下午 4:56 
 * Copyright © 2014-2017,52mamahome.com.All rights reserved
 * history :
 *     1. 2018/2/12  下午 4:56 created by lbb
 */
...
public class AclParam {
    ...
    @Length(min = 2, max = 20, message = "权限点名称长度需要在2-64字符内")
    private String name;

    @NotNull(message = "必须指定权限模块")
    private Integer aclModuleId;

    @Length(min = 6, max = 100, message = "权限点url长度需要在6-256字符内")
    private String url;
    ...
    @Length(min = 0, max = 200, message = "权限点备注长度需要在0-256字符内")
